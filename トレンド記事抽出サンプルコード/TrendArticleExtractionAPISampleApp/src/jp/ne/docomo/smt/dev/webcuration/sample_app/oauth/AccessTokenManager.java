...
public class AccessTokenManager implements OAuthCallback {
    ...
    private static final String OAUTH_CLIENT_ID = docomo Developer supportにて発行したCLIENT ID;
    private static final String OAUTH_CLIENT_SECRET = docomo Developer supportにて発行したCLIENT SECRET;
    private static final String OAUTH_SCOPE = "curation";
    private static final String OAUTH_REDIRECT_URI = docomo Developer supportにて指定したREDIRECT URI;
