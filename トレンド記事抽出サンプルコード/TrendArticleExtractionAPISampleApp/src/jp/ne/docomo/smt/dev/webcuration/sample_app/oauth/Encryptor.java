...
class Encryptor {
    ...
    private static final String TRANSFORMATION_BC = KEY_ALGORITHM + "/CBC/PKCS7Padding";
    private static final String TRANSFORMATION = KEY_ALGORITHM + "/CBC/PKCS5Padding";
    /** プロバイダ BouncyCastle */
    private static final String PROVIDER_BC = "BC";
    /** プロバイダ AndroidOpenSSL */
    ...
    byte[] decrypt(Context context, byte[] encrypted) {
    	...
    	try {
    		if(Build.VERSION.SDK_INT == 19){
    			...
    			cipher = Cipher.getInstance(TRANSFORMATION_BC, PROVIDER_BC);
    		}
